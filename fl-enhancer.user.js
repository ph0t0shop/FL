                    ...
                    if (node.src !== undefined) {
                        if (node.src.endsWith("mixins.js")) {
                            ...
                            window.requirejs = function(e,t,n,r){ // https://cdn.jsdelivr.net/gh/ph0t0shop/FL@prod/algoliabundle.js, http://127.0.0.1:5500/algoliabundle.js
                                if (Array.isArray(e) && e.length === 1 && e[0] === "algoliaBundle") return oldRequirejs(["http://127.0.0.1:5500/algoliabundle.js"], t, n, r);
                                return oldRequirejs(e.map(moduleName => {if (moduleName === "algoliaBundle") return "http://127.0.0.1:5500/algoliabundle.js"; return moduleName;}),t,n,r);
                            }
            ...
            for (const mutation of mutationList) {
                for (const node of mutation.addedNodes) {
                    ...
                    if (node.classList !== undefined && node.classList.contains("c-details-tab__description")) {
                        observer.disconnect();
                        requirejs(["http://127.0.0.1:5500/enhancelisting.js"]); // https://cdn.jsdelivr.net/gh/ph0t0shop/FL@prod/enhancelisting.js, http://127.0.0.1:5500/enhancelisting.js
                    }
                }
            }
        };
